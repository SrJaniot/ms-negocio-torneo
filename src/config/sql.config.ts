export namespace SQLConfig {
  ...
  export const validarAforoEvento = 'SELECT fun_validar_aforo_evento($1)';
  ...
  export const validarNumeroIntegrantesEquipoTorneo = 'SELECT fun_validar_numero_integrantes_equipo_torneo($1)';
  export const vincularUsuarioTorneo = 'SELECT fun_insert_usuario_torneo($1,$2)';
  export const vincularEquipoTorneo = 'SELECT fun_insert_equipo_torneo($1,$2,$3)';
